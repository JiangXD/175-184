...
extractData = function(fileID){
		   ...
		   ret=do.call(rbind, ret);
                   ...
                   mydat=read.table(pipe(paste0("sed -n '72,${H;n;H;n;H;n;H;n;H;n;H;n;H;n;g;s,\\r\\n, ,g;s,\\n,,g;s,[A-Za-z_#()],,g;p;s,^.*$,,g;h;}' m9c0r",fileID,".log")),header=FALSE);
